...
Idmsoft* GetDmObject()
{
	...
	pfnGCO fnGCO = NULL;
	HINSTANCE hdllInst = LoadLibrary(L"xm.dll");
...
BEGIN_MESSAGE_MAP(CGreenLegendApp, CWinApp)
...
CGreenLegendApp::CGreenLegendApp()
{
	// TODO: 在此处添加构造代码，
...
// 唯一的 CGreenLegendApp 对象

CGreenLegendApp theApp;


// CGreenLegendApp 初始化

BOOL CGreenLegendApp::InitInstance()
{
